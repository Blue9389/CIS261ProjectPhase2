...
def GetDatesWorked():
    ...
    fromdate = int(input("Enter the datepay period begin (mm/dd/yy): "))
    todate = int(input("Enter the date the pay perion ended (mm/dd/yy): "))
...
if __name__ == "__main__":
    ...
    while True:
        ...
        EmpDetail =[]
        EmpDetail.expand = [fromdate, todate, empname, hours, hourlyrate, taxrate]
